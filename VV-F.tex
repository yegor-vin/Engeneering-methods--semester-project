...
Current commercial systems like Google Maps provide highly accurate routing but rely on centralized infrastructure, user profiling, and opaque algorithms~\cite{google_privacy}. Recent opensource initiatives, including NLnet-funded mobility tools, show that independent, privacy-preserving routing is feasible but still underdeveloped for mobile devices~\cite{nlnet_case_study}. This identifies a clear research and innovation gap the project seeks to address.
...
\textbf{Justification:}  
This methodology ensures continuous progress and aligns with best practices for small scale applied research projects. Iterative development allows early detection of errors, while opensource publication guarantees transparency and reproducibility.

\subsection{Excellence of Supervisors and Institutional Competence}

Although the project is implemented by a team of first-year students, it is supervised by the Intelligent Data and Systems with Applications (IDSA) research group at FIIT STU. IDSA focuses on data-driven intelligent systems, Responsible AI, information privacy, and secure software development — all areas directly relevant to the project's goals.

The group provides essential expertise in:
\begin{itemize}
...
IDSA’s experience in AIOps, NLP, HCI, and intelligent applications ensures that the project is guided by established research methodologies and best practices. FIIT STU provides the necessary infrastructure, consultation, and academic support to enable the student team to develop a functional applied-research prototype. Despite the team's limited experience, the institutional environment offers strong competence and supervision to ensure feasibility and quality.

\subsection{Research Team Expertise and Development Vision}
The team consists of three first-year university students motivated to learn and participate in applied research. Despite limited prior experience, their competencies cover:
\begin{itemize}
...
All core contributors are young researchers under 20 years old. The project promotes early stage involvement in applied research through:
\begin{itemize}
...
\begin{itemize}
    ...
    Because the system relies exclusively on global open data standards (GTFS and OSM), it can be adapted to any country with litte to no modification. Developers abroad can reuse code, contribute improvements, or deploy the tool in new regions.
...
\midrule
Lack of experience & Will slow progress. Mitigation: learn from open-source examples, tutorials, mentor feedback. \\
Time management & Balancing university workload will reduce available time. Mitigation: weekly task planning. \\
